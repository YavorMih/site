        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
           <div className="grid grid-cols-1 lg:grid-cols-2">
               <div className="lg:order-2 p-8 md:p-12">
                  <div className="inline-block bg-blue-50 text-primary px-3 py-1 rounded-full text-xs font-bold mb-4">София, Лозенец</div>
                  <h2 className="text-3xl font-serif text-primary mb-4">Апартамент в Лозенец</h2>
                  <p className="text-gray-600 leading-relaxed mb-8">
                    Имот, който не е в идеалния център, но е перфектен за бизнес пътувания. Чрез правилно таргетиране успяхме да осигурим висока заетост и отлична доходност, надвишаваща дългосрочния наем.
                  </p>
                  <div className="grid grid-cols-2 gap-8 mb-8">
                     <div>
                        <span className="block text-4xl font-bold text-accent mb-1">+58%</span>
                        <span className="text-sm text-gray-500">Доходност</span>
                     </div>
                     <div>
                        <span className="block text-4xl font-bold text-accent mb-1">95 лв.</span>
                        <span className="text-sm text-gray-500">Ср. Цена</span>
                     </div>
                  </div>
               </div>
               <div className="lg:order-1 bg-gray-50 p-8 flex flex-col justify-center">
                   <h4 className="text-center text-gray-500 mb-6 text-sm uppercase font-semibold">Сравнение (BGN)</h4>
                   <div className="h-64">
                    <ResponsiveContainer width="100%" height="100%">
